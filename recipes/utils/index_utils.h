...
//   Coord(const std::tuple<int, int>& t) : x(std::get<0>(t)), y(std::get<1>(t)) {}
//
...
//   bool row_major;
//
//   Matrix(float* data, Coord size, bool is_row_major=true) : 
//     data(data), 
//     size(size), 
//     row_major(is_row_major) {}
//
//   Matrix& distribute(Coord id, Coord stride) {
//     data += id.x * stride.x + id.y * stride.y;
//     return *this;
//   }
//
//   Matrix& tile(Coord id, Coord from_stride, Coord to_stride) {
